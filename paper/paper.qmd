...
The remainder of this paper is structured as follows: @sec-data details the data and measurement process of the chosen dataset; @sec-model covers the multivariate linear regression model used in this paper; @sec-results provides results obtain from the derived model; and @sec-discussion includes discussions, such as implications and future steps, of our model, and how our results can in turn be furthermore improved.
